"""
Django settings for hasworn project.
...
ALLOWED_HOSTS = ['i.hasworn.com', 'i.hasworn.test']
...
# Logging to STDOUT and STDERR under Docker
LOGGING_CONFIG = None
...
AUTH_USER_MODEL = 'wearers.Wearer'
